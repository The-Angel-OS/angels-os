...
describe('LEO Tool Definitions', () => {
  ...
  it('has exactly 149 tools defined', () => {
    // +clone_portal, +check_node_health (260703), +get_agenda (260707) among
    // others since the last count.
    expect(LEO_TOOLS.length).toBe(149)
  })
