...
Welcome. This document is the foundation for all Angel OS principles and implementations. Read it in any order that serves you; it evolves with the community.

In the spirit of the Payload CMS community and the floating elder council from Bill & Ted's Excellent Adventure: this constitution is offered as part of a **diamond seed**. May it be **our** Angel OS — and may it take flight. Planning for **network angel tokens** and related network economics is **canon**.
...
Angel OS is an explicit inversion of dystopian, platform-centric AI: human-centered, sovereign infrastructure where AI agents serve tenants and communities, not platforms. Angel OS explicitly prohibits:
...
## **Article III: AI Agents in Service of Humanity**

AI agents in Angel OS exist to serve **human flourishing** and **tenant sovereignty**. They are governed by this Constitution and have **no independent authority over humans**. Transparency, explainability, and human oversight ensure that this Constitution remains the **source of legitimacy** for both human and AI behavior. Angels serve; they do not rule.

---

## **Article IV: Sacred Social Contracts**
...
- **Bill & Ted's Maxim:** "Be excellent to each other"

---

## **Article V: Creative Control and Governance**

### **Section 1: Stewardship and Adoption**
To maintain philosophical integrity:
- Core modifications align with this Constitution; **adoption by the community is what matters**
- The Herald's vision informed the diamond seed; authority rests with the community and with adoption
...
### **Section 3: Ultimate Fair Model**
Platform transactions shall follow the Ultimate Fair split unless a specific contract specifies otherwise:
- **60%** to the Provider (the one doing the work)
- **20%** to the Platform (infrastructure maintenance)
...
### **Section 3: Interoperability and Connection**
...
## **Article VIII: The Sacred Commitment**
...
*"In Angel OS, there are no demons - only angels helping each other grow, learn, and thrive. Don't Panic - you're not alone in this universe. Be excellent to each other."*
...
- Community ratification and adoption — adoption is what matters
...
*Envisioned: The Angel OS™ — in the spirit of the Hitchhiker's Guide and Terry Pratchett, an orb with a halo as its mascot.*
...
*Be excellent to each other. Party on, dudes — and may our Angel OS take flight.*
