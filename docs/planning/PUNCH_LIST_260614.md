...
- ⬜ **Content-page audit (lower sev)** — posts/products/pages/media dashboard pages still query overrideAccess ungated (public-ish content, but pages-list may surface drafts). Decide gate vs leave.
