...
- ⬜ NEXT: member dashboard (my membership / manage / cancel). ⚠️ live end-to-end needs a Connect-onboarded endeavor + a real subscription (membership verification wakeup's domain). First gym pilot on kendev = first paying non-church customer.
