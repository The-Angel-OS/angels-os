  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href="/admin/collections/posts/create?returnTo=/dashboard/posts&returnLabel=Posts"
      ...
      {(posts.totalDocs > 0 || hasFilter) && (
        <ListControls searchPlaceholder="Search posts…" tabParam="status" tabs={STATUS_TABS} />
      )}
      ...
      {posts.totalDocs === 0 && hasFilter ? (
            ...
            return (
              ...
              >
                ...
                <div className="flex shrink-0 gap-2">
                  ...
                  <Link
                    href={`/admin/collections/posts/${post.id}?returnTo=/dashboard/posts&returnLabel=Posts`}
                    className="rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium text-foreground hover:bg-muted"
                  >
                    Edit
                  </Link>
        ...
        <Pager page={posts.page || 1} totalPages={posts.totalPages} />
        </>
      )}
    </div>
  )
