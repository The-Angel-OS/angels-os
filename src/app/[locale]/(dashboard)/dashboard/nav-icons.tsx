/**
 * Dashboard navigation icons — extracted from DashboardSidebar.tsx
 * to keep the sidebar file focused on layout/logic.
 *
 * All icons are 16×16 (h-4 w-4) SVG stroke icons with 1.5 strokeWidth.
 */
...
/** Icon lookup table keyed by NavIconKey */
export const NAV_ICONS: Record<string, React.ComponentType> = {
  home: HomeIcon,
  grid: GridIcon,
  helm: HelmIcon,
  gear: GearIcon,
