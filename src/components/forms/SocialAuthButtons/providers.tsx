/**
 * Shared Social Auth Provider Metadata
 *
 * Single source of truth for provider display info (icons, colors, URLs)
 * and the list of currently-implemented providers.
 *
 * Used by:
 *   - SocialAuthButtons (login/signup forms)
 *   - SocialProvidersPanel (account settings — link/unlink)
 */
...
export interface ProviderMeta {
  ...
  /** OAuth initiation URL for linking (account settings) */
  linkUrl: string
}

/**
 * Display metadata for all known providers.
