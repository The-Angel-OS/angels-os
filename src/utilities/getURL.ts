...
/**
 * The registrable apex this node hangs tenant subdomains off, e.g. "spacesangels.com"
 * on every node today (260725 consolidation). Derived from NEXT_PUBLIC_SERVER_URL
